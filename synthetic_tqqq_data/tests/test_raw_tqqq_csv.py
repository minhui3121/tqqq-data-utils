...
class TestRawTqqqCsv(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_expected_rows_match_yahoo_values(self) -> None:
        self.assert_row_matches("2010-02-11", 0.20, 0.22)
        self.assert_row_matches("2020-03-30", 5.70, 6.13)
        self.assert_row_matches("2025-12-31", 54.13, 52.72)

    def test_first_and_last_row_dates(self) -> None:
        self.assertEqual(self.frame.iloc[0]["date"], "2010-02-11")
